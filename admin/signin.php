...
<head>
  ...
  <title>Furniture Studio | Admin - Dashboard</title>
        ...
        <div class="container mt-5">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <h3 class="login-heading text-center mb-4">Furniture Studio Management System</h3>
              <form method="post">
              <?php
              if(isset($error)){
                ...
                <div class="text-center">
                  <a class="small" href="forget_pass.php">Forgot password?</a></div><br>
				<a class="nav-link" href="http://localhost/furniture_shop/"><button type="button" class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2">Visit Website</button></a></li>
