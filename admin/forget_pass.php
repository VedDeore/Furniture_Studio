...
<section style="margin-top:100px;">
        ...
        <form class="text-center border border-light p-5" method="post" action="#!">
          <?php
            ...
            if(isset($_POST['submit'])){
                ...
                $query = "SELECT * FROM admin WHERE email='$email' ORDER BY id";
                ...
                if(empty($email) or empty($password)){
                    ...
                    if($db_email != $email ){
                        ...
                        $u_query = "UPDATE admin SET password='$password' WHERE email='$email' ";
    ...
    <!-- Password -->
    <input type="password" name="password" id="defaultRegisterFormPassword" class="form-control" placeholder="New Password" aria-describedby="defaultRegisterFormPasswordHelpBlock">
    <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted mb-4">
    </small>

  

    <input class="btn btn-info my-3 btn-block" type="submit"  name="submit" value="Change Password">
